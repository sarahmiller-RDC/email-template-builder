import svgPaths from "./svg-fcpzfkbss9";
    ...
    <div className="relative shrink-0 w-full" data-name="Information">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[31px] items-start pb-0 pt-[40px] px-[40px] relative w-full">
          <p className="font-['Helvetica:Bold',sans-serif] leading-[40px] not-italic relative shrink-0 text-[#1a1816] text-[32px] text-nowrap whitespace-pre">[Email name/type]</p>
          <Divider />
          <p className="font-['Helvetica:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#1a1816] text-[24px] text-nowrap tracking-[0.48px] whitespace-pre">Subject: [subject line]</p>
          <div className="font-['Helvetica:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-black text-nowrap whitespace-pre">
...
function TextBlock() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start not-italic relative shrink-0" data-name="Text block">
      <p className="font-['Helvetica:Bold',sans-serif] leading-[40px] relative shrink-0 text-[#1a1816] text-[32px] w-[600px]">[H1]</p>
      <div className="font-['Helvetica:Regular',sans-serif] leading-[24px] relative shrink-0 text-[16px] text-black w-[600px]">
...
function H3AndBody() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start leading-[24px] not-italic relative shrink-0 text-[16px] w-full" data-name="H3 and Body">
      <p className="font-['Helvetica:Bold',sans-serif] relative shrink-0 text-[#1a1816] w-full">{`[Bolded body copy] `}</p>
      <p className="font-['Helvetica:Regular',sans-serif] relative shrink-0 text-black w-full">[body]</p>
    </div>
  );
}
    ...
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="Panel">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-start p-[32px] relative w-full">
          <p className="font-['Helvetica:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#1a1816] text-[24px] tracking-[0.48px] w-full">[H2] header text</p>
          <H3AndBody />
          <PrimaryButton />
        </div>
      </div>
...
function LeadInfo() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Lead info">
      <SpotProfile />
      <p className="font-['Helvetica:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#1a1816] text-[24px] text-nowrap tracking-[0.48px] whitespace-pre">[Lead Name]</p>
    </div>
  );
}
...
function LeadInfo1() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-full" data-name="Lead info">
      <LeadInfo />
      <p className="font-['Helvetica:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[#1a1816] text-[18px] w-full">[Lead Address]</p>
    </div>
  );
}
...
function LeadInfo2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Lead info">
      <p className="basis-0 font-['Helvetica:Bold',sans-serif] grow leading-[1.4] min-h-px min-w-px not-italic relative shrink-0 text-[#1a1816] text-[18px]">Note from client:</p>
    </div>
  );
}
...
function LeadInfo3() {
  return (
    <div className="content-stretch flex flex-col gap-[2px] items-center relative shrink-0 w-full" data-name="Lead info">
      <LeadInfo2 />
      <p className="font-['Helvetica:Oblique',sans-serif] italic leading-[1.4] relative shrink-0 text-[#1a1816] text-[18px] w-full">“[Note]”</p>
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="bg-[#f2f0ef] relative rounded-[16px] shrink-0 w-full">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="box-border content-stretch flex flex-col font-['Helvetica:Regular',sans-serif] gap-[12px] items-center justify-center leading-[0] not-italic p-[24px] relative text-[#1a1816] w-full">
...
function LeadInfo4() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-center not-italic relative shrink-0 text-[#1a1816] w-full" data-name="Lead info">
      <p className="font-['Helvetica:Bold',sans-serif] leading-[32px] relative shrink-0 text-[24px] tracking-[0.48px] w-full">Proposal details</p>
      <div className="font-['Helvetica:Regular',sans-serif] leading-[1.4] relative shrink-0 text-[0px] text-[16px] w-full">
    ...
    <div className="relative rounded-[16px] shrink-0 w-full" data-name="Panel: Proposal">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[24px] items-start p-[32px] relative w-full">
          <LeadInfo4 />
          <PrimaryButton2 />
          <p className="font-['Helvetica:Regular',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[#1a1816] text-[16px] w-full">Before calling, take a moment to review your proposal, as [Name] may not have reviewed it yet.</p>
        </div>
      </div>
    </div>
  );
...
function HelpBox() {
  return (
    <div className="h-[74px] relative rounded-[8px] shrink-0 w-full" data-name="Help box">
      ...
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[12px] h-[74px] items-center justify-center px-[32px] py-[12px] relative w-full">
          <SpotSupport />
          <p className="basis-0 font-['Helvetica:Regular',sans-serif] grow leading-[1.45] min-h-px min-w-px not-italic relative shrink-0 text-[#1a1816] text-[16px]">[Message]</p>
        </div>
      </div>
    </div>
  );
...
function HelpSection() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Help Section">
      <p className="font-['Helvetica:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#1a1816] text-[24px] tracking-[0.48px] w-full">Need help?</p>
      <HelpBox />
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full">
      <IconPhone />
      <p className="font-['Helvetica:Regular',sans-serif] leading-[1.43] not-italic relative shrink-0 text-[#1a1816] text-[16px] text-nowrap whitespace-pre">email@realtor.com</p>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full">
      <IconEmail />
      <p className="font-['Helvetica:Regular',sans-serif] leading-[1.43] not-italic relative shrink-0 text-[#1a1816] text-[16px] text-nowrap whitespace-pre">(650) 226-7449</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 w-full" data-name="Realtor signature">
      ...
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[8px] items-start px-[32px] py-[8px] relative w-full">
          <p className="font-['Helvetica:Bold',sans-serif] leading-[32px] not-italic relative shrink-0 text-[#1a1816] text-[24px] tracking-[0.6px] w-full">[Sender Name]</p>
          <p className="font-['Helvetica:Bold',sans-serif] leading-[1.43] not-italic relative shrink-0 text-[#1a1816] text-[16px] w-full">{`[Sender title] `}</p>
          <Frame1 />
          <Frame />
          <p className="font-['Helvetica:Regular',sans-serif] leading-[1.43] not-italic relative shrink-0 text-[#1a1816] text-[16px] w-full">Move Sales, Inc., operator of Realtor.com©</p>
        </div>
      </div>
    </div>
  );
...
function Email() {
  return (
    <div className="content-stretch flex flex-col gap-[40px] items-center relative shrink-0" data-name="Email">
      <EmailContainer />
      <Footer />
    </div>
  );
...
export default function StandardTemplate() {
  return (
    <div className="bg-white relative size-full" data-name="Standard Template">
