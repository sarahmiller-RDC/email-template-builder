        ...
        data: {
          ...
          elements: [
            ...
            },
            {
              id: 'elem-2',
              type: 'bodyText',
              content: '<strong>Log in or create your account</strong>',
            },
            {
              id: 'elem-3',
              type: 'bodyText',
              content: 'Access your RealPro Dashboard at <u>dashboard.realtor.com</u>. If you don\'t have an account, create one.',
            },
            {
              id: 'elem-4',
              type: 'bodyText',
              content: '<em>Forgot Your Password? Click \'Forgot Password\' on the login page to reset your credentials if needed.</em>',
            },
            {
              id: 'elem-5',
              type: 'bodyText',
              content: '<strong>Accept your invitation</strong>',
            },
            {
              id: 'elem-6',
              type: 'bodyText',
